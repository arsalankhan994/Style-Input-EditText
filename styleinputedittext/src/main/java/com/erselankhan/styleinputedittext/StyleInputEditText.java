package com.erselankhan.styleinputedittext;
...
public class StyleInputEditText extends RelativeLayout {
    ...
    public StyleInputEditText(Context context) {
        this(context, null);
    }

    public StyleInputEditText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StyleInputEditText(final Context context, AttributeSet attrs, int defStyleAttr) {
